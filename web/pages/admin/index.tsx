...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      <div className="flex flex-col py-20 md:flex-row bg-white rounded-lg shadow-xl">
        ...
        <div className="flex flex-col justify-center items-center w-full md:w-1/2 p-8 overflow-auto">
          ...
          <form className="w-full md:w-[70%]" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="bg-blue-500 text-white py-2 px-8 rounded-lg transition-colors w-full"
              disabled={isLoading}
            >
