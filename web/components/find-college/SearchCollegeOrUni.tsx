...
import UniversitiesDataContext from '@/contexts/UniversitiesDataContext';
...
const SearchCollegeOrUni: React.FC = () => {
  ...
  return (
    <UniversitiesDataContext.Provider value={universitiesData} >
    ...
    </UniversitiesDataContext.Provider >
